<article {{ $attributes }}>
    ...
    <div class="question text-center">
        ...
        <h4 class="text-xl">Tendencia a ser amigables con las personas que se parecen a ti, preferir a la gente con la
            que tenemos algo
            en
            común. De esta manera tendemos a contratar o promocionar a personas que comparten la misma raza, género,
            edad,
            formación académica o aficiones contigo.</h4>

        <x-autoevaluacion.custom-range pretext="No me influye nada" postext="Me influye mucho"
    ...
    <div class="question text-center">
        ...
        <h4 class="text-xl">Se refiere a cómo percibimos nuestras acciones y las de las demás personas. Tendemos a
            atribuir nuestros propios éxitos a nuestras habilidades y nuestros fracasos a factores fuera de nuestro
